...
function drawPlanet() {
  if (window.orbitPerformance?.lowPower) {
    const ringTilt = -0.28;
    const ringWidth = planetRadius * 1.72;
    const ringHeight = planetRadius * 0.36;

    ctx.save();
    ctx.strokeStyle = "rgba(120, 219, 255, 0.34)";
    ...
    surface.addColorStop(0.22, "#63d8ff");
    surface.addColorStop(0.56, "#3953c7");
    ...
    ctx.strokeStyle = "rgba(225, 250, 255, 0.5)";
    ctx.beginPath();
